  ...
  return (
    <div className="mobile-gate">
      ...
      <div className="mobile-gate__content">
        {/* Custom Logo */}
        <div className="mobile-gate__icon" style={{ marginBottom: '16px' }}>
          <img src="/logo.webp" alt="Logo" style={{ height: '24px', width: 'auto', objectFit: 'contain', filter: 'drop-shadow(0 2px 10px rgba(0,0,0,0.5))' }} />
        </div>
        ...
        <div className="mobile-gate__message">
          ...
          <img src="/desktop.webp" alt="Desktop Preview" className="mobile-gate__preview" />
